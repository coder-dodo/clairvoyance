...
BREEZE_BUDDY_VAD_CONFIDENCE = os.getenv("BREEZE_BUDDY_VAD_CONFIDENCE", 0.7)   # Require stronger confidence
BREEZE_BUDDY_VAD_START_SECS = os.getenv("BREEZE_BUDDY_VAD_START_SECS", 0.2)   # Pick up quicker
BREEZE_BUDDY_VAD_STOP_SECS = os.getenv("BREEZE_BUDDY_VAD_STOP_SECS", 0.8)     # Allow small pauses
BREEZE_BUDDY_VAD_MIN_VOLUME = os.getenv("BREEZE_BUDDY_VAD_MIN_VOLUME", 0.6)   # More tolerant for soft voice
BREEZE_BUDDY_STT_SERVICE = os.getenv("BREEZE_BUDDY_STT_SERVICE", "google").lower()  # "google" or "openai"
